...
<script> 
    ...
    function init() {
        var mapOptions = {
            center: new google.maps.LatLng(34.147151,-118.345901),
            zoom: 9,
            zoomControl: true,
            zoomControlOptions: {
        ...
        var locations = [
['Me :)', 'undefined', 'undefined', 'undefined', 'undefined', 34.23740947418436, -118.52817026441801, 'https://mapbuildr.com/assets/img/markers/solid-pin-red.png']
        ];
